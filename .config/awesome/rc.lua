...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey }, "c", function()
		awful.spawn("xsel -o -p | xsel -i -b")
	end),
	-- Copy clipboard to primary (gtk to terminals)
	awful.key({ modkey }, "v", function()
		awful.spawn("xsel -o -b | xsel -i -p")
	end),
...
local desktop_rules = {
	{ rule = { class = "Slack" }, properties = { screen = 2, tag = awful.util.tagnames[3] } },

	{ rule = { class = "discord" }, properties = { screen = 2, tag = awful.util.tagnames[5] } },

	{ rule = { class = "Enpass" }, properties = { screen = 4, tag = awful.util.tagnames[9] } },

	{ rule = { class = "Kodi" }, properties = { screen = 4 } },
}
